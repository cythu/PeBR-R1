...
def main():
    ...
    print(f"🕒 [START] Data sampling started at {datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    ...
    print(f"✅ Data sampling completed. Total duration: {int(duration)} seconds ≈ {duration/60:.2f} minutes.")
