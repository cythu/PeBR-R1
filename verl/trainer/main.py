...
def main():
    ...
    print(f"🕒 [START] RL training started at {datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    ...
    print(f"✅ RL training completed. Total duration: {int(duration)} seconds ≈ {duration/60:.2f} minutes.")
